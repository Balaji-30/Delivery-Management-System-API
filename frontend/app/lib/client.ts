...
/** Body_reset_delivery_partner_password */
export interface BodyResetDeliveryPartnerPassword {
  /** Password */
  password: string;
}

/** Body_reset_seller_password */
export interface BodyResetSellerPassword {
  /** Password */
  password: string;
}
...
export interface DeliveryPartnerUpdate {
  /** Serviceable Zipcodes */
  serviceable_zipcodes?: number[] | null;
  /** Max Handling Capacity */
...
/** ShipmentCancel */
export interface ShipmentCancel {
  /**
   * Id
   * @format uuid
   */
...
export interface ShipmentCreate {
  ...
  /**
   * Destination
   * Pincode of the delivery location
   */
  destination: number;
  /**
   * Customer Email
...
> extends HttpClient<SecurityDataType> {
  seller = {
     ...
     *
     * @tags Seller
     * @name GetSellerResetPasswordForm
     * @summary Get Seller Reset Password Form
     * @request GET:/seller/reset_password_form
     */
    getSellerResetPasswordForm: (
      query: {
        /** Token */
        token: string;
      },
  ...
  shipment = {
     ...
     * @secure
     */
    cancelShipment: (data: ShipmentCancel, params: RequestParams = {}) =>
      this.request<ShipmentRead, HTTPValidationError>({
  ...
  partner = {
     ...
     *
     * @tags Delivery Partner
     * @name VerifyDeliveryPartner
     * @summary Verify Delivery Partner
     ...
     *
     * @tags Delivery Partner
     * @name DeliveryPartnerForgotPassword
     * @summary Delivery Partner Forgot Password
     ...
     *
     * @tags Delivery Partner
     * @name GetDeliveryPartnerResetPasswordForm
     * @summary Get Delivery Partner Reset Password Form
     * @request GET:/partner/reset_password_form
     */
    getDeliveryPartnerResetPasswordForm: (
      query: {
        /** Token */
        token: string;
      },
     ...
     *
     * @tags Delivery Partner
     * @name ResetDeliveryPartnerPassword
     * @summary Reset Delivery Partner Password
    ...
    resetDeliveryPartnerPassword: (
      ...
      data: BodyResetDeliveryPartnerPassword,
      params: RequestParams = {},
    ) =>
      this.request<any, HTTPValidationError>({
