...
Revision ID: 7330b6b2b4d8
Revises: 
Create Date: 2025-11-17 16:53:06.367594
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['zip_code'], ['location.zip_code'], ),
    sa.PrimaryKeyConstraint('delivery_partner_id', 'zip_code')
    )
